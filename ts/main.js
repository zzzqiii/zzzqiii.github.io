(() => {
  // ns-hugo:E:\cloud\blog\assets\ts\gallery.ts
  ...
  // ns-hugo:E:\cloud\blog\assets\ts\color.ts
  var colorsCache = {};
  ...
  // ns-hugo:E:\cloud\blog\assets\ts\menu.ts
  ...
  // ns-hugo:E:\cloud\blog\assets\ts\createElement.ts
  ...
  // ns-hugo:E:\cloud\blog\assets\ts\colorScheme.ts
  var StackColorScheme = class {
    constructor(toggleEl) {
      this.localStorageKey = "StackColorScheme";
      this.bindMatchMedia();
      this.currentScheme = this.getSavedScheme();
      this.dispatchEvent(document.body.dataset.scheme);
      if (toggleEl)
